...
public class Association extends DynamicResource implements IAssociation {
  ...
  public Association setCardinality(ch.actifsource.graphviz.generic.javamodel.ICardinality cardinality) {
  ...
  public Association setTarget(ch.actifsource.graphviz.generic.javamodel.IClass target) {
  ...
  public static java.util.List<ch.actifsource.graphviz.generic.javamodel.IAssociation> selectToMeTarget(ch.actifsource.graphviz.generic.javamodel.IClass object) {
    return _getToMeList(object.getRepository(), ch.actifsource.graphviz.generic.javamodel.IAssociation.class, ch.actifsource.graphviz.generic.GenericPackage.Association_target, object.getResource());
  }
  
  public static ch.actifsource.graphviz.generic.javamodel.IAssociation selectToMeCardinality(ch.actifsource.graphviz.generic.javamodel.ICardinality object) {
    return _getToMeSingle(object.getRepository(), ch.actifsource.graphviz.generic.javamodel.IAssociation.class, ch.actifsource.graphviz.generic.GenericPackage.Association_cardinality, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,39f81717-ee7c-11ef-8f29-099ac721970d,nyyGPABQk38lO6pgHvMC4qleBFw=] */
