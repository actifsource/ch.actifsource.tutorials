...
public class Cardinality extends DynamicResource implements ICardinality {
  ...
  public java.lang.Integer selectMax() {
    return _getSingleAttribute(java.lang.Integer.class, ch.actifsource.tutorial.graphviz.generic.GenericPackage.Cardinality_max);
  }
    
  public void setMax(java.lang.Integer max) {
     _setSingleAttribute(ch.actifsource.tutorial.graphviz.generic.GenericPackage.Cardinality_max, max);
  }

  @Override
  public java.lang.Integer selectMin() {
    return _getSingleAttribute(java.lang.Integer.class, ch.actifsource.tutorial.graphviz.generic.GenericPackage.Cardinality_min);
  }
    
  public void setMin(java.lang.Integer min) {
     _setSingleAttribute(ch.actifsource.tutorial.graphviz.generic.GenericPackage.Cardinality_min, min);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptSingleAttribute(java.lang.Integer.class, ch.actifsource.tutorial.graphviz.generic.GenericPackage.Cardinality_max, visitor);
    _acceptSingleAttribute(java.lang.Integer.class, ch.actifsource.tutorial.graphviz.generic.GenericPackage.Cardinality_min, visitor);
    // relations
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,39f81714-ee7c-11ef-8f29-099ac721970d,t/fgys8Wu5YwUbYHCrwSIN4W1t0=] */
