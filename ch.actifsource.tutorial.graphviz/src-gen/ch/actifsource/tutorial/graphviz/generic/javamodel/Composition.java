...
public class Composition extends DynamicResource implements IComposition {
  ...
  public Composition setCardinality(ch.actifsource.tutorial.graphviz.generic.javamodel.ICardinality cardinality) {
  ...
  public Composition setTarget(ch.actifsource.tutorial.graphviz.generic.javamodel.IClass target) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,39f8171b-ee7c-11ef-8f29-099ac721970d,VuzUCGv+54v6pTfhDENkGL/HkHM=] */
