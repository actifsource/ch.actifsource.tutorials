...
public class Visibility extends DynamicResource implements IVisibility {
  ...
  public java.lang.String selectUmlSymbol() {
    return _getSingleAttribute(java.lang.String.class, ch.actifsource.tutorial.graphviz.generic.GenericPackage.Visibility_umlSymbol);
  }
    
  public void setUmlSymbol(java.lang.String umlSymbol) {
     _setSingleAttribute(ch.actifsource.tutorial.graphviz.generic.GenericPackage.Visibility_umlSymbol, umlSymbol);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, ch.actifsource.tutorial.graphviz.generic.GenericPackage.Visibility_umlSymbol, visitor);
    // relations
  ...
  public boolean isPublic() {
    return getResource().equals(ch.actifsource.tutorial.graphviz.generic.GenericPackage.Visibility_public);
  }
  
  @Override
  public boolean isProtected() {
    return getResource().equals(ch.actifsource.tutorial.graphviz.generic.GenericPackage.Visibility_protected);
  }
  
  @Override
  public boolean isPrivate() {
    return getResource().equals(ch.actifsource.tutorial.graphviz.generic.GenericPackage.Visibility_private);
  }
  
  @Override
  public boolean isPackage() {
    return getResource().equals(ch.actifsource.tutorial.graphviz.generic.GenericPackage.Visibility_package);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,39f816f8-ee7c-11ef-8f29-099ac721970d,am67Hi19Mx6Y1Js95M1sSbJfLKQ=] */
